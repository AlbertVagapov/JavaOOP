public class Program {
    ...
    public static void main(String[] args) {
        Product milk = new Milk("Деревенское", 60, 6, "Литр", "6 месяцев", 2);
        Product limonade = new Drinks("Cola", 56, 12, "Литр", 2);
        Product bread = new Bread("Бородинский", 45, 1, "шт", "3 дня", "1 сорт");
        Product eggs = new Eggs("Простоквашино", 82, 10, "шт", "3 нед", 10);
        Product masks = new Masks("Avon", 455, 12, "шт", 12);
        Product pappare = new ToiletPappar("Zeva", 275, 12, "шт", 12, 2);
        Product diapers = new Diapers("Oriflame", 1112, 56, "шт.", 2, "да", 12, 5, 7, "Дышаший");
